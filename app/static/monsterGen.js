...
var stepOneDescription = {
  "Combatant": "The combatant option is for an NPC that will primarily fight in physical combat, such as a bodyguard or a feral beast. Such NPCs represent significant threats on the field of battle. These attacks are often physical but they might also be strange supernatural abilities.",
  "Expert": "Pick the expert option for skilled enemies such as stealthy scouts or non-combatants such as merchants or advisors. Expert NPCs benefit from a wide array of skills, making them competent at specialized tasks such as sneaking or sabotage.",
  "Spellcaster": "Use the spellcaster option for any NPC whose main capabilities come from casting spells or using spell-like abilities. Spellcaster NPCs usually have the most unusual abilities."
}
...
classData = {"Mystic": {"Description": "Calling on connections to supernatural forces, mystics can manifest magic in a number of different ways.", "Skills": " Master Mysticism and good or master skills chosen from the connection's associated skills.", "Special Rules": " Choose one mystic connection. The mystic creature's connection powers must come from that connection. Any connection powers that aren't relevant to the creature (or that can simply be incorporated into the creature's statistics) don't need to appear in its stat block. Spells must come from the mystic spell list. Start with connection spells of the corresponding levels and then fill in the remaining slots.", "Adjustments": " None.", "Required Array": " Spellcaster.", "abilitiesByCr": {"11": "1st-, 3rd-, 6th-, and 9th-level connection powers; mindlink; and telepathic bond.", "12": "1st-, 3rd-, 6th-, 9th-, and 12th-level connection powers; mindlink; and telepathic bond.", "15": "1st-, 3rd-, 6th-, 9th-, 12th-, and 15th-level connection powers; mindlink; and telepathic bond.", "19": "All connection powers, mindlink, telepathic bond, and transcendence.", "18": "All connection powers, mindlink, and telepathic bond.", "1": "1st-level connection power and one special ability.", "3": "1st- and 3rd-level connection powers and mindlink.", "2": "1st-level connection power, mindlink, and one special ability.", "6": "1st-, 3rd-, and 6th-level connection powers and mindlink.", "9": "1st-, 3rd-, 6th-, and 9th-level connection powers and mindlink.", "20": "All connection powers, mindlink, telepathic bond, transcendence, and enlightenment."}, "Ability Score Modifiers": " Wisdom, Constitution, and Charisma.", "Gear": " Light armor (item level = CR), small arm (item level = CR), and basic melee weapon (item level = CR - 1)."}, "Envoy": {"Gear": " Light armor (item level = CR), small arm (item level = CR), and basic melee weapon (item level = CR - 1).", "Skills": " Master Sense Motive and master Bluff, Diplomacy, or Intimidate.", "Adjustments": " +2 to Reflex saving throws.", "Required Array": " Expert.", "abilitiesByCr": {"10": "Two 8th-level envoy improvisations, one 6th-level envoy improvisation, one 4th-level envoy improvisation, skillful special ability, and one special ability.", "12": "Three 8th-level envoy improvisations, one 6th-level envoy improvisation, skillful special ability, and one special ability.", "20": "True expertise, four 8th-level envoy improvisations, skillful special ability, and one special ability.", "16": "Four 8th-level envoy improvisations, skillful special ability, and one special ability.", "1": "One 1st-level envoy improvisation and one special ability.", "2": "Two 1st-level envoy improvisations and one special ability.", "4": "One 4th-level envoy improvisation, one 1st-level envoy improvisation, and one special ability.", "6": "One 6th-level envoy improvisation, one 4th-level envoy improvisation, one 1st-level envoy improvisation, and one special ability.", "9": "One 8th-level envoy improvisation, one 6th-level envoy improvisation, one 4th-level envoy improvisation, skillful special ability, and one special ability.", "8": "One 8th-level envoy improvisation, one 6th-level envoy improvisation, one 4th-level envoy improvisation, and one special ability."}, "Ability Score Modifiers": " Charisma, Intelligence, and Dexterity.", "Description": "Charismatic envoys assist their allies through inspiration and tactical orders."}, "Soldier": {"Gear": " A soldier creature's gear selection depends on whether it's focused on melee or ranged combat.", "Ranged": " Heavy armor (item level = CR), advanced melee weapon (item level = CR), longarm (item level = CR + 1) or heavy weapon (item level = CR), and two grenades (item level = CR).", "Special Rules": " Choose one fighting style (soldier creatures of CR 9 or higher also choose a secondary fighting style). The soldier creature's style techniques must come from the selected fighting style or styles. Any style techniques that aren't relevant to the soldier creature can be skipped (or can simply be incorporated into the creature's statistics) and don't need to appear in the creature's stat block.", "Adjustments": " -2 to Reflex saving throws and +2 to Will saving throws.", "Required Array": " Combatant.", "Melee": " Heavy armor (item level = CR), advanced melee weapon (item level = CR + 1), longarm (item level = CR), and two grenades (item level = CR).", "abilitiesByCr": {"11": "1st-, 5th-, and 9th-level style techniques; secondary fighting style; 1st-level secondary style technique; soldier's onslaught; two gear boosts; and one special ability.", "13": "1st-, 5th-, 9th-, and 13th-level style techniques; secondary fighting style; 1st- and 5th-level secondary style techniques; soldier's onslaught; and three special abilities.", "20": "1st-, 5th-, 9th-, 13th-, and 17th-level style techniques; second style; 1st-, 5th-, and 9th-level secondary style techniques; soldier's onslaught; kill shot; two gear boosts; and one special ability.", "17": "1st-, 5th-, 9th-, 13th-, and 17th-level style techniques; second style; 1st-, 5th-, and 9th-level secondary style techniques; soldier's onslaught; two gear boosts; and one special ability.", "1": "1st-level style technique and one special ability.", "2": "1st-level style technique, one gear boost, and one special ability.", "5": "1st- and 5th-level style techniques, one gear boost, and one special ability.", "7": "1st- and 5th-level style techniques, two gear boosts, and one special ability.", "9": "1st-, 5th-, and 9th-level style techniques; secondary fighting style; 1st-level secondary style technique; two gear boosts; and one special ability."}, "Ability Score Modifiers": " A soldier creature should arrange its ability score modifiers depending on its focus in combat. Melee", "Description": "Equipped with powerful weapons and armor, soldiers are trained to serve in the front line of battle and to both dish out and withstand massive force."}, "Solarian": {"Description": "Drawing power from the eternal cycles of stars, solarians fight with the power of photons and gravitons.", "Skills": " Good Mysticism.", "Special Rules": " Choose one solar manifestation, either solar armor or solar weapon. For a solarian creature with solar armor, its EAC and KAC each increase by 1 and it receives the energy resistance listed in the table of solarian class features. For a solarian creature with a solar weapon, that weapon deals the standard melee damage for the NPC's CR from Table 2", "Solar Weapon": " Light armor (item level = CR), small arm (item level = CR), and solarian crystal (item level = CR).", "Adjustments": " -2 to Reflex saving throws and +2 to Will saving throws.", "Required Array": " Combatant.", "Solar Armor": " Light armor (item level = CR), small arm (item level = CR), and advanced melee weapon (item level = CR + 1).", "abilitiesByCr": {"10": "Solar manifestation, stellar alignment, black hole, supernova, flashing strikes, one 10th-level stellar revelation, one 6th-level stellar revelation, and one zenith revelation.", "13": "Solar manifestation, stellar alignment, black hole, supernova, flashing strikes, solarian's onslaught, two 10thlevel stellar revelations, and one zenith revelation.", "20": "Solar manifestation, stellar alignment, black hole, supernova, flashing strikes, solarian's onslaught, stellar apotheosis, two 14th-level stellar revelations, and two zenith revelations.", "14": "Solar manifestation, stellar alignment, black hole, supernova, flashing strikes, solarian's onslaught, one 14thlevel stellar revelation, one 10th-level stellar revelation, and one zenith revelation.", "17": "Solar manifestation, stellar alignment, black hole, supernova, flashing strikes, solarian's onslaught, two 14thlevel stellar revelations, and two zenith revelations.", "1": "Solar manifestation, stellar alignment, black hole, and supernova.", "2": "Solar manifestation, stellar alignment, black hole, supernova, and one 2nd-level stellar revelation.", "4": "Solar manifestation, stellar alignment, black hole, supernova, and two 2nd-level stellar revelations.", "7": "Solar manifestation, stellar alignment, black hole, supernova, flashing strikes, one 6th-level stellar revelation, and one 2nd-level stellar revelation.", "6": "Solar manifestation, stellar alignment, black hole, supernova, one 6th-level stellar revelation, and one 2nd-level stellar revelation.", "9": "Solar manifestation, stellar alignment, black hole, supernova, flashing strikes, two 6th-level stellar revelations, and one zenith revelation.", "8": "Solar manifestation, stellar alignment, black hole, supernova, flashing strikes, and two 6th-level stellar revelations."}, "Ability Score Modifiers": " Strength, Dexterity, and Charisma.", "Gear": " A solarian's gear selection depends on whether you choose solar armor or solar weapon for its solar manifestation."}, "Mechanic": {"Description": "Experts at dealing with machines, mechanics either use exocortexes to enhance their combat abilities or are accompanied by robotic drones that they can control remotely.", "Skills": " Master Computers and Engineering.", "Special Rules": " All mechanic creatures get the artificial intelligence class feature, which requires a choice between a drone and an exocortex. For a mechanic creature with a drone, build the drone as a separate technological construct of the mechanic's CR - 2 or use an existing technological construct with the mechanic's CR - 2. The drone does not get a full suite of actions on its own; each round, the mechanic creature and the drone can each take a move action, a swift action, and a reaction, but only one of them can take a standard action or combine its move and standard actions into a full action. The drone doesn't have its own CR, it doesn't contribute to the CR of the encounter, and PCs receive no XP for defeating a drone. For a mechanic creature with an exocortex, add target tracking at CR 1 (see below), wireless hack at CR 5, twin tracking at CR 10, multitasking at CR 15, and quad tracking at CR 20. Target Tracking (Ex)", "Adjustments": " +2 to Fortitude and Reflex saving throws and -2 to Will saving throws.", "Required Array": " Expert.", "abilitiesByCr": {"11": "Artificial intelligence, overload, remote hack, expert rig, miracle worker 2/day, override, and two 8th-level mechanic tricks.", "13": "Artificial intelligence, overload, remote hack, miracle worker 2/day, override, advanced rig, and two 8th-level mechanic tricks.", "20": "Artificial intelligence, overload, remote hack, miracle worker 3/day, override, ghost in the machine, superior rig, and four 14th-level mechanic tricks.", "14": "Artificial intelligence, overload, remote hack, miracle worker 2/day, override, advanced rig, one 14th-level mechanic trick, and one 8th-level mechanic trick.", "16": "Artificial intelligence, overload, remote hack, miracle worker 3/day, override, advanced rig, and two 14th-level mechanic tricks.", "19": "Artificial intelligence, overload, remote hack, miracle worker 3/day, override, ghost in the machine, superior rig, and three 14th-level mechanic tricks.", "18": "Artificial intelligence, overload, remote hack, miracle worker 3/day, override, advanced rig, and three 14th-level mechanic tricks.", "1": "Artificial intelligence (see Special Rules above), custom rig, one special ability.", "3": "Artificial intelligence, custom rig, overload, and one 2ndlevel mechanic trick.", "2": "Artificial intelligence, custom rig, one 2ndlevel mechanic trick, and one special ability.", "5": "Artificial intelligence, custom rig, overload, remote hack, and two 2nd-level mechanic tricks.", "4": "Artificial intelligence, custom rig, overload, and two 2ndlevel mechanic tricks.", "7": "Artificial intelligence, overload, remote hack, expert rig, miracle worker 1/day, and two 2nd-level mechanic tricks.", "9": "Artificial intelligence, overload, remote hack, expert rig, miracle worker 1/day, override, one 8th-level mechanic trick, and one 2nd-level mechanic trick.", "8": "Artificial intelligence, overload, remote hack, expert rig, miracle worker 1/day, one 8th-level mechanic trick, and one 2nd-level mechanic trick."}, "Ability Score Modifiers": " Intelligence, Dexterity, and Constitution.", "Gear": " Light armor (item level = CR), small arm (item level = CR), and basic melee weapon (item level = CR - 1)."}, "Technomancer": {"Description": "These spellcasters meld magic and technology.", "Skills": " Master Computers and good Mysticism.", "Special Rules": " In general, spells must come from the technomancer spell list. When choosing a spell for cache capacitor, you don't have to choose one of the spells from the list of the spells the technomancer knows.", "Adjustments": " None.", "Required Array": " Spellcaster.", "Ability Score Modifiers": " Intelligence, Dexterity, and Wisdom.", "Gear": " Light armor (item level = CR), small arm (item level = CR), and basic melee weapon (item level = CR - 1)."}, "Operative": {"Description": "Cunning and swift, operatives are especially skilled and can cause foes to drop their guards, paving the way for devastating attacks.", "Skills": " Master skills from operative specialization.", "Special Rules": " Choose one operative specialization. The operative creature's specialization exploit and specialization power must come from that specialization. Any exploits that aren't relevant to the creature (or that can simply be incorporated into the creature's statistics) don't need to appear in the creature's stat block.", "Adjustments": " Bonus to initiative equal to the creature's CR divided by 4, + 1; +3 to Reflex saving throws; +1 to all skill checks.", "Required Array": " Expert.", "abilitiesByCr": {"11": "Trick attack +6d8, evasion, quick movement +20 ft., debilitating trick, uncanny agility, triple attack, specialization power, specialization exploit, and one 10th-level operative exploit.", "10": "Trick attack +5d8, evasion, quick movement +20 ft., debilitating trick, uncanny agility, triple attack, specialization exploit, and one 10th-level operative exploit.", "13": "Trick attack +7d8, evasion, quick movement +20 ft., debilitating trick, uncanny agility, quad attack, specialization power, specialization exploit, and one 10th-level operative exploit.", "15": "Trick attack +8d8, evasion, quick movement +30 ft., debilitating trick, uncanny agility, quad attack, specialization power, specialization exploit, and one 14th-level operative exploit.", "14": "Trick attack +7d8, evasion, quick movement +20 ft., debilitating trick, uncanny agility, quad attack, specialization power, specialization exploit, and one 14th-level operative exploit.", "17": "Trick attack +9d8, evasion, quick movement +30 ft., debilitating trick, uncanny agility, quad attack, double debilitation, specialization power, specialization exploit, and one 14th-level operative exploit.", "19": "Trick attack +10d8, evasion, quick movement +30 ft., debilitating trick, uncanny agility, quad attack, double debilitation, specialization power, specialization exploit, and two 14th-level operative exploits.", "20": "Trick attack +10d8, evasion, quick movement +30 ft., debilitating trick, uncanny agility, quad attack, double debilitation, specialization power, specialization exploit, supreme operative, and two 14th-level operative exploits.", "1": "Trick attack +1d4 and one special ability.", "3": "Trick attack +1d8, evasion, quick movement +10 ft., one 2nd-level operative exploit, and one special ability.", "2": "Trick attack +1d4, evasion, one 2nd-level operative exploit, and one special ability.", "5": "Trick attack +3d8, evasion, quick movement +10 ft., debilitating trick, specialization exploit, and two 2nd-level operative exploits.", "4": "Trick attack +1d8, evasion, quick movement +10 ft., debilitating trick, and two 2nd-level operative exploits.", "7": "Trick attack +4d8, evasion, quick movement +10 ft., debilitating trick, uncanny agility, specialization exploit, and one 6th-level operative exploit.", "6": "Trick attack +3d8, evasion, quick movement +10 ft., debilitating trick, specialization exploit, and one 6th-level operative exploit.", "9": "Trick attack +5d8, evasion, quick movement +20 ft., debilitating trick, uncanny agility, triple attack, specialization exploit, and one 6th-level operative exploit.", "8": "Trick attack +4d8, evasion, quick movement +10 ft., debilitating trick, uncanny agility, triple attack, specialization exploit, and one 6th-level operative exploit."}, "Ability Score Modifiers": " Dexterity, Intelligence, and Wisdom.", "Gear": " Light armor (item level = CR), small arm (item level = CR), sniper rifle (item level = CR), and basic melee weapon with operative special quality (item level = CR - 1)."}};
...
$(".dropdown-menu li a").click(function(){
  ...
  if (selected.includes("Combatant") || selected.includes("Expert") || selected.includes("Spellcaster")) {
    ...
    $descriptionArea.append(stepOneDescription[selected]);
  }
  else {
    $(this).closest('.btn-group').find('.dropdown-toggle').html('<span class="pull-left">' + selected + '</span><span class="caret"></span>');
    $(this).closest('.btn-group').find('.dropdown-toggle').val(selected);
