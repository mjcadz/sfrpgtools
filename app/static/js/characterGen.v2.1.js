...
var PersonalityList = ['Accusative', 'Active', 'Adventurous', 'Affable', 'Aggressive',
    ...
    'Docile', 'Doleful', 'Dominating', 'Dramatic', 'Dull',
    ...
    'Feral', 'Fierce', 'Feisty', 'Flamboyant', 'Flippant',
    ...
    'Kind', 'Know-it-all', 'Languid', 'Lazy', 'Lethargic', 'Lying',
    'Likable', 'Lippy', 'Listless', 'Loquacious', 'Loving', 'Loyal',
    ...
    'Prejudiced', 'Pretentious', 'Preoccupied', 'Proper',
    'Proselytizing', 'Proud', 'Prudent', 'Prying', 'Puerile',
    'Pugnacious', 'Quiet', 'Quirky', 'Rascal', 'Rash', 'Realistic',
    ...
    'Sensible', 'Sensitive', 'Sentimental', 'Serene', 'Serious',
    'Servile', 'Shallow', 'Shameful', 'Shameless',
    ...
    'Stoic', 'Stubborn', 'Submissive', 'Superstitious', 'Surly',
    'Suspicious', 'Sybarite', 'Sycophantic', 'Sympathetic', 'Taciturn',
    'Tactful', 'Teetotaler', 'Temperamental', 'Tempestuous',
    ...
    'Vivacious', 'Vulgar', 'Wasteful', 'Weary',
